...
function Features() {
   return (
      <Section className="bg-yellow-100 bg-opacity-50 relative my-6">
         {/* left content */}
         ...
         <div className="relative mt-16 lg:pl-9 md:pl-6 pb-4 lg:pb-0">
            ...
            <Title styledCustom="text-xl" title="choose your Favorit coffee" />
            <p className="my-4">
               <span className="text-amber-600 text-2xl">Drip</span> | Cappucino
               | Mocha
            </p>
            <SubTitle
