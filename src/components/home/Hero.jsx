...
function Hero() {
   return (
      <Section className="mx-auto mt-12 mb-8">
         <div className="text-center md:text-left xl:py-12 lg:pt-7 md:pt-4 mt-10 md:mt-0 mb-12 md:mb-0">
            <h1 className="lg:text-[50px] md:text-3xl capitalize text-3xl font-bold text-amber-900 md:pr-10 tracking-wider leading-relaxed lg:leading-relaxed">
            ...
            coffee."
            />
            <div className="relative flex md:mt-9 mt-16 w-full px-2 md:w-8/12 md:px-0 justify-evenly md:justify-between lg:justify-evenly">
               <ButtonBasic
                  href="/products"
                  title="Get Coffee"
                  styledCustom="bg-amber-100 shadow-lg md:w-36 py-3 px-2"
               />
