...
const BlogList = () => {
    ...
    return (
        <>
            <SeoHelmetComponent
                title={"horizon blog"}
                content={"blog konten coffee shop horizon, kumpulan artikel seputar perkopian dan keseharian"}
                href={"/blog"}
            />
            <Layout>
                <div
                    className="w-full md:h-52 h-48 flex items-center justify-center bg-gradient-to-b from-yellow-100 to-white bg-opacity-50 text-center">
